...
### 5) Мобильный предпросмотр

После запуска сервера в консоли будут выведены IP-адреса для доступа с мобильных устройств:

```
📱 Mobile preview available at:
   http://192.168.1.100:5000
   http://10.0.0.5:5000
```

**Важно:**
- Убедитесь, что ваш компьютер и мобильное устройство подключены к одной Wi‑Fi сети
- Используйте один из указанных IP-адресов на мобильном устройстве
- Если адресы не отображаются, проверьте настройки брандмауэра Windows (разрешите входящие подключения на порт 5000)
