...
- ✅ **Консистентность типографики Select компонентов** - Унифицирован размер текста
  - SelectItem и SelectLabel теперь используют `text-sm leading-snug md:text-xs`
  - Соответствие SelectTrigger для единообразного внешнего вида
  - Улучшенная визуальная консистентность во всех dropdown меню
