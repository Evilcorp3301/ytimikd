...
### Фаза 1: Критические (High Impact, Low Effort)
1. ✅ Увеличение превью видео до `md`/`lg`
2. ✅ Добавление прогресс-бара на карточках видео
3. ✅ Группировка языков по статусу
