...
Примечание: глобальные действия (например, “добавить подкатегорию”) не дублируются в хедере страницы категорий — добавление подкатегории доступно внутри карточек категории.
