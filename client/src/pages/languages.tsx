...
export default function LanguagesPage() {
  ...
  const languageFormSchema = z.object({
    code: z.string().min(2, t("languages.codeMinLength")).max(10, t("languages.codeMaxLength")),
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: t("languages.languageAdded"),
        description: t("languages.languageAddedDescription"),
      });
      setDialogOpen(false);
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/languages"] });
      toast({
        title: t("languages.languageRemoved"),
        description: t("languages.languageRemovedDescription"),
      });
    },
    onError: (error) => {
      toast({
    ...
    <div className="flex flex-1 flex-col">
      ...
      <PageContainer>
        <div className="mb-4 md:mb-6 lg:mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-heading-3">{t("languages.description")}</p>
            {languages.length > 0 && (
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t("languages.languageCodePlaceholder")}
                            {...field}
