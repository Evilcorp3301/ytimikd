      ...
      <PageContainer>
        <div className="mb-4 md:mb-6 lg:mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-heading-3">
            Визуальный справочник дизайн-системы
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Семантические классы для текста
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Токены для отступов и скруглений
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground text-center">--radius-sm<br />3px</p>
                  </div>
                  <div className="space-y-2">
                    <div className="w-20 h-20 rounded-[var(--radius-md)] bg-primary/20 border border-primary/40"></div>
                    <p className="text-xs text-muted-foreground text-center">--radius-md<br />6px</p>
                  </div>
                  <div className="space-y-2">
                    <div className="w-20 h-20 rounded-[var(--radius-lg)] bg-primary/20 border border-primary/40"></div>
                    <p className="text-xs text-muted-foreground text-center">--radius-lg<br />9px</p>
                  </div>
                  <div className="space-y-2">
                    <div className="w-20 h-20 rounded-[var(--radius-pill)] bg-primary/20 border border-primary/40"></div>
                    <p className="text-xs text-muted-foreground text-center">--radius-pill<br />9999px</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Токены для высоты и размеров элементов
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
