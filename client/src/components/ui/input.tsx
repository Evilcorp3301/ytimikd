    ...
    return (
      <input
        ...
        className={cn(
          ...
          "ios-input-text flex h-[var(--input-height)] w-full rounded-[var(--radius-md)] border border-input bg-background px-3 py-2 text-body leading-snug ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-sm placeholder:text-placeholder-foreground shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:shadow-md focus-visible:border-border transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
        {...props}
