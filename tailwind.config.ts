  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        placeholder: {
          foreground: "hsl(var(--placeholder-foreground) / <alpha-value>)",
        },
        sidebar: {
      ...
      fontSize: {
        "heading-1": "1.125rem" /* 18px */,
        "heading-2": "1rem" /* 16px */,
        "heading-3": "0.875rem" /* 14px */,
      },
      /* Shadows use Tailwind defaults (shadow-sm, shadow-md, etc.) */
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
